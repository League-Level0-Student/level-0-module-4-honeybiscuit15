...
public class FruitQuiz extends KeyAdapter {
	...
	void makeQuestions() {
		...
		question2 = new JLabel("<html>How many 0.5cm slices of breads can you cut from a whole bread that's 25cm long?<br> A: 1 <br> B: 25 <br> C: 39<br> D: None of the above</html>");
	}
